...
<h2 class="mb-4">¡Bienvenido! Crea tu cuenta de empresa</h2>
<p class="lead mb-4">Después podrás publicar tu primera oferta</p>
<p>¿Ya tienes una cuenta? <a href="{{ route('login', ['type' => 'empresa']) }}">Accede aquí</a></p>

<form class="form-row form-dark align-items-center" method="POST" action="{{ route('register') }}">
    @csrf
    <input type="hidden" name="type" value="E">
    <div class="form-group col-sm-12">

    <input type="text" class="form-control" id="name" placeholder="Nombre de la empresa" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
    ...
    <div class="form-group col-sm-6">
     <input type="email" class="form-control" id="email" placeholder="Email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
    ...
    <div class="form-group col-sm-6">
      <input type="password" id="password"  class="form-control" placeholder="Contraseña" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
    ...
    <div class="col-xl-6 col-lg-5 conten-img-empresa">
    </div>
@endsection
