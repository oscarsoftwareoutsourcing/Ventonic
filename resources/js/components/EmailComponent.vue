                            ...
                            <div class="sidebar-menu-list" style="overflow:auto">
                                <div class="list-group list-group-messages font-medium-1">
                                    <a href="javascript:void(0)" @click="setFolder('inbox')" class="list-group-item list-group-item-action border-0 pt-0 active">
                                        ...
                                        <span class="badge badge-primary badge-pill float-right" v-if="inboxUnread > 0">{{ inboxUnread }}</span>
                                    </a>
                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action border-0" @click="setFolder('sent')">
                                        ...
                                        <span class="badge badge-success badge-pill float-right" v-if="messages_send.length > 0">{{ messages_send.length }}</span>
                                    </a>
                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action border-0" @click="setFolder('draft')">
                                        ...
                                        <span class="badge badge-primary badge-pill float-right" v-if="draft.length > 0">{{ draft.length }}</span>
                                    </a>
                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action border-0" @click="setFolder('favorites')">
                                        ...
                                        <span class="badge badge-warning badge-pill float-right" v-if="favorites.length > 0">{{ favorites.length }}</span>
                                    </a>
                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action border-0" @click="setFolder('spam')">
                                        ...
                                        <span class="badge badge-danger badge-pill float-right" v-if="spam.length > 0">{{ spam }}</span>
                                    </a>
                                    <a href="javascript:void(0)" class="list-group-item list-group-item-action border-0" @click="setFolder('trash')">
                                        ...
                                        <span class="badge badge-danger badge-pill float-right" v-if="trash.length > 0">{{ trash.length }}</span>
                                    </a>
                                </div>
                                <hr />
                                <h5 class="my-2 pt-25">Etiquetas</h5>
                                <div class="list-group list-group-labels font-medium-1">
                                    <a class="list-group-item list-group-item-action border-0 d-flex align-items-center" href="javascript:void(0)">
                        ...
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title text-text-bold-600" id="emailCompose">{{ titleSentMessage }}</h3>
                                ...
                                <div class="modal-body pt-1">
                                    ...
                                    <div class="form-label-group">
                                        <input type="text" id="emailSubject" class="form-control" placeholder="Asunto" name="fname-floating" v-model="sent.subject" data-toggle="tooltip" title="Asunto del correo electrónico" :class="{'has-error': hasErrors('subject')}" />
                                    ...
                                    <div class="form-label-group">
                                        <input type="text" id="emailCC" class="form-control" placeholder="CC" name="fname-floating" v-model="sent.cc" data-title="tooltip" title="correo electrónico a quién enviar una copia" :class="{'has-error': hasErrors('cc')}" />
                                    ...
                                    <div class="form-label-group">
                                        <input type="text" id="emailBCC" class="form-control" placeholder="BCC" name="fname-floating" v-model="sent.bcc" data-toggle="tooltip" title="dirección de correo a quién enviar una copia oculta" :class="{'has-error': hasErrors('bcc')}" />
                                    ...
                                    <div id="email-container">
                                        ...
                                        <textarea class="form-control" cols="30" rows="4" v-model="sent.message" placeholder="Mensaje" data-toggle="tooltip" title="Mensaje del correo electrónico" :class="{'has-error': hasErrors('message')}"></textarea>
                                    ...
                                    <div class="form-group mt-2">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="emailAttach" data-toggle="tooltip" title="archivo adjunto" />
                                ...
                                <div class="email-app-list">
                                        ...
                                        <div class="action-right">
                                            <ul class="list-inline m-0">
                                                <li class="list-inline-item">
                                                    <a href="javascript:void(0)" data-toggle="tooltip" title="verificar correos nuevos">
                                    ...
                                    <div class="email-user-list list-group" style="overflow:auto">
                                        <ul class="users-list-wrapper media-list">
                                            <li class="media" v-for="email in emails.inbox" v-if="showFolder==='inbox'" :class="{'mail-read': (typeof(email.read)!=='undefined') ? email.read : false}">
                                                <div class="media-left pr-50">
                                                    ...
                                                    <div class="user-action">
                                                        <div class="vs-checkbox-con">
                                                            ...
                                                            <input type="checkbox" :value="email.message_id" v-model="selectedMessages" class="checkboxEmail" />
                                                        ...
                                                        <span class="favorite">
                                                            <i class="feather icon-star" :id="email.message_id" @click="setFavorite(email.message_id)"></i>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="media-body" @click="openContent(email)">
                                                    <div class="user-details">
                                                        <div class="mail-items">
                                                            <h5 class="list-group-item-heading text-bold-600 mb-25">{{ email.from[0].personal }}</h5>
                                            ...
                                            <li class="media" v-for="email in emails.sent" v-if="showFolder==='sent'" :class="{'mail-read': (typeof(email.read)!=='undefined') ? email.read : false}">
                                                <div class="media-left pr-50">
                                                    <div class="avatar">
                                                        <img src="/images/anonymous-user.png" alt="avatar img holder" />
                                                    </div>
                                            ...
                                            <li class="media" v-for="email in emails.draft" v-if="showFolder==='draft'" :class="{'mail-read': (typeof(email.read)!=='undefined') ? email.read : false}">
                                                <div class="media-left pr-50">
                                                    <div class="avatar">
                                                        <img src="/images/anonymous-user.png" alt="avatar img holder" />
                                                    </div>
                                            ...
                                            <li class="media" v-for="email in favorites" v-if="showFolder==='favorites'" :class="{'mail-read': (typeof(email.read)!=='undefined') ? email.read : false}">
                                                <div class="media-left pr-50">
                                                    <div class="avatar">
                                                        <img src="/images/anonymous-user.png" alt="avatar img holder" />
                                                    </div>
                                            ...
                                            <li class="media" v-for="email in emails.spam" v-if="showFolder==='spam'" :class="{'mail-read': (typeof(email.read)!=='undefined') ? email.read : false}">
                                                <div class="media-left pr-50">
                                                    <div class="avatar">
                                                        <img src="/images/anonymous-user.png" alt="avatar img holder" />
                                                    </div>
                                            ...
                                            <li class="media" v-for="email in trash" v-if="showFolder==='trash'" :class="{'mail-read': (typeof(email.read)!=='undefined') ? email.read : false}">
                                                <div class="media-left pr-50">
                                                    <div class="avatar">
                                                        <img src="/images/anonymous-user.png" alt="avatar img holder" />
                                                    </div>
                            ...
                            <div class="email-app-details">
                                ...
                                <div class="email-scroll-area" style="overflow:auto">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card px-1">
                                                <div class="card-header email-detail-head ml-75" v-if="Object.keys(selectedEmail).length > 0 && selectedEmail.constructor === Object">
                                                    <div class="user-details d-flex justify-content-between align-items-center flex-wrap">
                                                        <div class="avatar mr-75">
                                                            <img src="/images/anonymous-user.png" alt="avtar img holder" width="61" height="61" />
                                                        </div>
                                                        <div class="mail-items">
                                                            <h4 class="list-group-item-heading mb-0">{{ selectedEmail.from[0].personal }}</h4>
                                                            <div class="email-info-dropup dropdown">
                                                                <span class="dropdown-toggle font-small-3" id="dropdownMenuButton200" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{ selectedEmail.from[0].mail }}</span>
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        <span class="font-medium-1">
                                                            ...
                                                            <span class="primary cursor-pointer">
                                                                <a href="javascript:void(0)" @click="replyMessage()" data-toggle="modal" data-target="#composeForm">
                                                                    <strong>Responser</strong>
                                                                </a>
                                                            </span> o
                                                            <span class="primary cursor-pointer">
                                                                <a href="javascript:void(0)" @click="forwardMessage()" data-toggle="modal" data-target="#composeForm">
...
export default {
    ...
    methods: {
        ...
        sentMessage() {
            ...
            axios.post("/email/sent", formData, {
                headers: {
