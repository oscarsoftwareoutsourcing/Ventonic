                          ...
                          <div class="user-action">
                            ...
                            <span class="favorite">
                              <i
                                ...
                                :id="email.message_id"
                                @click="setFavorite(email.message_id)"
                              ></i>
                            </span>
                          </div>
                        </div>
