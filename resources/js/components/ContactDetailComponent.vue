        ...
        <div class="card-content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <div class="form-row mb-1">
                            <div class="col-12">
                                <span class="font-weight-bold capitalize text-display-5">
                                    {{ contact.name }} {{ contact.last_name }}
                                </span>
                                <a href="javascript:void(0)" @click="editContact()" data-toggle="tooltip"
            ...
            -->
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-row mb-1">
                            <div class="col-12">
                                <a href="javascript:void(0)" @click="viewMap()" data-toggle="modal" data-target="#modalMap">
                                    Ver mapa
                                </a>
                            </div>
                        </div>
                ...
                <ul class="nav nav-tabs nav-justified" id="myTab2" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active nav-component" id="profile-tab-justified" data-toggle="tab" href="#profile-just" role="tab" aria-controls="profile-just" aria-selected="false">Actividades</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-component" id="messages-tab-justified" data-toggle="tab" href="#messages-just" role="tab" aria-controls="messages-just" aria-selected="false">Eventos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-component" id="settings-tab-justified" data-toggle="tab" href="#settings-just" role="tab" aria-controls="settings-just" aria-selected="false">Documentos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-component" id="home-tab-justified" data-toggle="tab" href="#home-just" role="tab" aria-controls="home-just" aria-selected="true">Correos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-component" id="calls-tab-justified" data-toggle="tab" href="#calls-just" role="tab" aria-controls="calls-just" aria-selected="true">Llamadas</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-component" id="tasks-tab-justified" data-toggle="tab" href="#tasks-just" role="tab" aria-controls="tasks-just" aria-selected="true">Tareas</a>
                    </li>
                </ul>
                <!-- Tab panes -->
