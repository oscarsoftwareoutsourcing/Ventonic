                  ...
                  >
                    ...
                    <div class="row" v-if="typeProvider">
                      <div class="col-12" v-if="typeProvider === 'google'">
                        ...
                        <ul>
                          <li>
                            ...
                            ubicado en la parte superior derecha Presione sobre
                            el botón
                          ...
                          <li>
                            ...
                            la opción
                            <strong>"Acceso de apps menos segura"</strong>
                            y darle a la opción de habilitar
                          </li>
                        </ul>
                      </div>
                      ...
                      <div
                        class="col-12"
                        v-if="
                          typeProvider === 'google' || typeProvider === 'yahoo'
                        "
                      >
                        <p>
                      ...
                      <div class="col-lg-5 col-md-5 col-xs-11">
                        <div class="form-group">
                          ...
                          <input
                            ...
                            data-toogle="tooltip"
                            title="Nombre del usuario con el que accede a la cuenta a ser vinculada"
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <button
                      ...
                      title="Pulse sobre el botón para actualizar la configuración de la cuenta de correo externa"
                      data-toggle="tooltip"
                      @click="update = false"
                    >
                      Actualizar conexión
