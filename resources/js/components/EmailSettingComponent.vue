                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            ...
                            <div v-if="!configStarted">
                                <div class="card-body">
                                    Conecta tu dirección de correo electrónico para disfrutar de todo el potencial de Ventonic
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <button type="button" class="btn btn-primary btn-sm float-right"
                                                    ...
                                                    data-toggle="tooltip" @click="configStarted=true">
                                                Iniciar
                                            </button>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="true"
                                                           id="rememberPassword" data-toggle="tooltip"
                                                           title="Si marca esta opción la contraseña será guardada en nuestro sistema, de lo contrario le será solicitada en cada proceso de gestión de correo" v-model="rememberPassword">
