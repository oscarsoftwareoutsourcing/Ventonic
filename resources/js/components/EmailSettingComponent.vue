...
export default {
    ...
    watch: {
        typeProvider: function() {
            const vm = this;
            vm.autoConfig =
                vm.typeProvider !== "" && vm.typeProvider !== "others";
            vm.setAutoConfig();
            ...
            if (vm.email && vm.username && vm.password) {
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        vm.outgoing_server_host =
                            response.data.serverInfo.out_host;
                        vm.incoming_server_port = response.data.serverInfo.port;
                        vm.outgoing_server_port =
                            response.data.serverInfo.out_port;
        ...
        layerSecurityMsg: function() {
            ...
            if (vm.email !== "") {
                if (vm.email.includes("@gmail")) {
                    ...
                    vm.email.includes("@yahoo") ||
                    vm.email.includes("@aol")
                ) {
            ...
            axios
                ...
                .then(response => {
                    if (response.data.result) {
                        ...
                        vm.incoming_server_host =
                            response.data.incoming_server_host;
                        vm.outgoing_server_host =
                            response.data.outgoing_server_host;
                        vm.incoming_server_port =
                            response.data.incoming_server_port;
                        vm.outgoing_server_port =
                            response.data.outgoing_server_port;
