                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div v-if="!configStarted">
                                ...
                                <div class="card-body">Conecta tu dirección de correo electrónico para disfrutar de todo el potencial de Ventonic</div>
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <button type="button" class="btn btn-primary btn-sm float-right" title="Pulse sobre el botón para iniciar el proceso de configuración" data-toggle="tooltip" @click="configStarted=true">Iniciar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div v-else>
                                <div class="card-body">
                                    ...
                                    <form-wizard title="Configuración de correo"
                                        ...
                                        <tab-content title="Proveedor de correo" :before-change="validateWizardFirst">
                                            ...
                                            <div class="row" v-if="typeProvider">
                                                <div class="col-12" v-if="typeProvider==='google'">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            Haga clic en el icono del perfil de la cuenta ubicado en la parte superior derecha Presione sobre el botón <strong>"Gestionar tu cuenta de Google"</strong>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            En el listado de opciones presentado, hacer clic en la opción <strong>"Acceso de apps menos segura"</strong> y darle a la opción de habilitar
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="col-12" v-if="typeProvider==='yahoo'">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            Haga clic en el ícono del perfil de la cuenta ubicado en la parte superior derecha
                                                        </li>
                                                        <li>Presione sobre el botón "Información de la cuenta"</li>
                                                        <li>
                                                            En la siguiente página, presionar sobre la opción "Seguridad de la cuenta" del menú lateral izquierdo
                                                        </li>
                                                        <li>
                                                            En el listado de opciones presentado, hacer clic en la opción "Administrar contraseñas de aplicaciones"
                                                        </li>
                                                        <li>
                                                            Posteriormente se debe seleccionar el tipo de aplicación, en cuyo caso se selecciona la opción "otras aplicaciones"
                                                        </li>
                                                        <li>Presionar sobre el botón "generar contraseña"</li>
                                                        <li>
                                                            Copiar la contraseña generada ya que esta será la que se utilizará en el proceso de configuración de correo en Ventonic en lugar de la contraseña normal del usuario
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" v-model="protocol" :class="{'has-error': hasErrors('protocol')}" :disabled="autoConfig">
                                                            <option value="imap">IMAP</option>
                                                            <option value="pop3">POP3</option>
                                                        </select>
                                                        <span class="invalid-feedback mb-3" role="alert" v-if="hasErrors('protocol')">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" v-model="incoming_server_host" :class="{'has-error': hasErrors('incoming_server_host')}" :readonly="autoConfig" />
                                                        <span class="invalid-feedback mb-3" role="alert" v-if="hasErrors('incoming_server_host')">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" v-model="incoming_server_port" :class="{'has-error': hasErrors('incoming_server_port')}" :readonly="autoConfig" />
                                                        <span class="invalid-feedback mb-3" role="alert" v-if="hasErrors('incoming_server_port')">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-xs-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" v-model="outgoing_server_host" :class="{'has-error': hasErrors('outgoing_server_host')}" :readonly="autoConfig" />
                                                        <span class="invalid-feedback mb-3" role="alert" v-if="hasErrors('outgoing_server_host')">
                                                ...
                                                <div class="col-lg-2 col-md-2 col-xs-12">
                                                    <div class="form-group">
                                                        <label for>Puerto</label>
                                                        <input type="text" class="form-control" v-model="outgoing_server_port" :class="{'has-error': hasErrors('outgoing_server_port')}" :readonly="autoConfig" />
                                                        <span class="invalid-feedback mb-3" role="alert" v-if="hasErrors('outgoing_server_port')">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-xs-12">
                                            <div class="form-group">
                                                <label for>Su nombre</label>
                                                <input type="text" class="form-control" v-model="name" :class="{'has-error': hasErrors('name')}" />
                                        ...
                                        <div class="col-lg-6 col-md-6 col-xs-12">
                                            <div class="form-group">
                                                <label for>Dirección de correo</label>
                                                <input type="email" class="form-control" v-model="email" :class="{'has-error': hasErrors('email')}" />
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-xs-12">
                                            <div class="form-group">
                                                <label for>Nombre de usuario</label>
                                                <input type="text" class="form-control" v-model="username" :class="{'has-error': hasErrors('username')}" />
                                                <span class="invalid-feedback mb-3" role="alert" v-if="hasErrors('username')">
                                                    <strong>{{ errors.username }}</strong>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-xs-12">
                                            <div class="form-group">
                                                <label for>Contraseña</label>
                                                <input type="password" class="form-control" v-model="password" :class="{'has-error': hasErrors('password')}" />
                                                <span class="invalid-feedback mb-3" role="alert" v-if="hasErrors('password')">
                                                    <strong>{{ errors.password }}</strong>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer" v-if="update">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <button type="button" class="btn btn-primary btn-sm float-left" title="Pulse sobre el botón para desvincular la cuenta configurada" data-toggle="tooltip" @click="removeSettings">Eliminar</button>
