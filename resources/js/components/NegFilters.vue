                    ...
                    >
                      <span class="vs-checkbox-con vs-checkbox-primary">
                        ...
                        <span>
                          {{status.status}}
                          <i
                            :title="'Negociaciones en ' + status.status"
                            class="ml-1"
                            v-bind:class="classes[status.id]"
                          ></i>
                        </span>
                      </span>
                    </li>
...
export default {
  ...
  methods: {
    ...
    resetContactFilter() {
      this.getNegFilters.contact = null;
    },
  ...
  computed: {
    ...
    see: {
      get() {
        return this.getNegFilters.see;
      },
      set(val) {
        this.getNegFilters.see = val;
      },
    },
    owner: {
      get() {
        return this.getNegFilters.owner;
      },
      set(val) {
    ...
    contact: {
      get() {
        return this.getNegFilters.contact;
      },
      set(val) {
    ...
    from: {
      get() {
        return this.getNegFilters.from;
      },
      set(val) {
        this.getNegFilters.from = val;
      },
    },
    to: {
      get() {
        return this.getNegFilters.to;
      },
      set(val) {
        this.getNegFilters.to = val;
      },
    },
    fromImport: {
      get() {
        return this.getNegFilters.fromAmount;
      },
      set(val) {
        this.setFromAmount(val);
      },
    },
    toImport: {
      get() {
        return this.getNegFilters.toAmount;
      },
      set(val) {
        this.setToAmount(val);
      },
    },
    owners() {
      let arr = [];
