                ...
                <div class="card-body">
                    ...
                    <div id="dates">
                        ...
                        <ul class="list-unstyled categories-list">
                            ...
                            <li>
                                <datepicker class="py-25" :bootstrap-styling="true" :language="es"
                                            :highlighted="highlighted" placeholder="Escoger una fecha" :format="format"
                                            v-model.trim="from" :disabled="disableDatePickers"></datepicker>
                            </li>
                            <li>
                                <datepicker class="py-25" :bootstrap-styling="true" :language="es"
                                            :highlighted="highlighted" placeholder="Escoger una fecha" :format="format"
                                            v-model.trim="to" :disabled="disableDatePickers"></datepicker>
                            </li>
                        </ul>
                    </div>
                    <hr>
                    ...
                    <div class="multi-range-price">
                        ...
                        <ul class="list-unstyled price-range" id="price-range">
                            ...
                            <li class="py-25">
                                <input name="txtAmountFrom" id="txtAmountFrom" v-model.trim="fromImport" type="text"
                                       placeholder="Importe" class="form-control" :disabled="disableImport">
                            </li>
                            <li class="py-25">
                                <input name="txtAmountTo" id="txtAmountTo" v-model.trim="toImport" type="text"
                                       placeholder="Importe" class="form-control" :disabled="disableRange">
                            </li>
                        </ul>
                    </div>
                </div>
