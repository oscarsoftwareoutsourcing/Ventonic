                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content pt-1">
                            <div class="tab-pane pb-3 active" id="profile-just" role="tabpanel"
                                ...
                                <!-- Notas -->
                                <note ref="negotiationNote" :model-relation-id="getDetailedNeg.id"
                                      model-relation-class="negotiation"></note>
                            </div>
                            <div class="tab-pane pb-3" id="messages-just" aria-labelledby="messages-tab-justified"
                                 role="tabpanel">
                                <!-- Evento -->
                                <event ref="negotiationEvent" :model-relation-id="getDetailedNeg.id"
                                       model-relation-class="negotiation"></event>
                            </div>
                            <div class="tab-pane pb-3" id="settings-just" aria-labelledby="settings-tab-justified"
                                 role="tabpanel">
                                 <!-- Documentos -->
                                <media-file ref="negotiationDocument" :model-relation-id="getDetailedNeg.id"
                                            model-relation-class="negotiation"></media-file>
                            </div>
