<template>
    ...
    <!-- Modal -->
    <div class="modal fade" id="newContactModal"  tabindex="-1" role="dialog" aria-labelledby="newContactModalTitle"
                    ...
                    <div class="form-row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select custom-select-sm" id="contactType" v-model="type"
                    ...
                    <div class="form-row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-label-group">
                                <input type="text" class="form-control" id="contactName" v-model="name"
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-label-group">
                                <input type="text" class="form-control" id="contactLastName" v-model="lastName"
