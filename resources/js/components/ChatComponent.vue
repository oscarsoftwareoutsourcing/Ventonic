        ...
        <div class="sidebar-left">
            <div class="sidebar">
                ...
                <div class="sidebar-content card">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <fieldset class="form-group position-relative has-icon-left mx-1 my-0 w-100">
                                <input type="text" class="form-control round" id="chat-search"
                                       placeholder="Buscar o iniciar nuevo chat" v-model="searchText">
                    ...
                    <div class="chat-user-list list-group position-relative user-list-scroll"
    ...
    export default {
        ...
        methods: {
            ...
            searchInChat() {
                ...
                axios.post('/filter-chat-users', {filter: vm.searchText}).then(response => {
                    vm.chatOrigins = response.data.chatOrigins;
                }).catch(error => {
                    console.error(error);
                });
