            ...
            <div class="card-ventonic">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12">
                        <a class="btn btn-primary text-white" href="javascript:void(0)" data-toggle="modal" data-target="#inlineForm">+ Nuevo</a>
                    </div>
                </div>
                <hr />
                <div class="row">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="accordion" id="accordionExample">
                                        <div class="card">
                                            ...
                                            <div :id="'collapseThree' + widget.id" class="collapse"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="text-center">
                                                        Como segundo paso debes insertar las siguientes etiquetas en la sección de tu web donde quieras que se muestre
                                                    </div>
                                                    <fieldset class="form-group mb-2">
                                                        <textarea class="form-control" id="labelHtml" rows="3"
                                                                  :disabled="isDisabled" placeholder="Textarea">
                                        ...
                                        <div class="card-btns d-flex justify-content-between mt-2">
                                            <div class="custom-control custom-switch custom-control-inline">
                                                <input type="checkbox" class="custom-control-input"
                                                       v-model="widget.status" :id="widget.id"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form-wizard title subtitle @on-complete="GenerateWidget" @on-error="handleErrorMessage" color="#7367F0" finish-button-text="Generar widget" next-button-text="Siguiente" back-button-text="Anterior">
                            <tab-content title="Obtener PIN del vendedor" icon="fa fa-user-o">
                                <br class="my-2" />
                                <p class="text-center">Pide el PIN a tu vendedor</p>
                                <br class="my-2" />
                            </tab-content>
                            <tab-content title="Validación de PIN" icon="fa fa-check" :before-change="beforeTabSwitch">
                                <br class="my-2" />
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <div class="form-label-group">
                                            <input v-model="pin" type="text" class="form-control col-md-6 offset-md-3" placeholder="Ingrese su PIN de vendedor aquí" />
                                        </div>
                                    </div>
                                    <br class="my-2" />
                                </div>
                            </tab-content>
                            <tab-content title="Generar widget" :before-change="validateWidgetName" icon="fa fa-cloud-download">
                                <br class="my-2" v-if="!generated" />
                                <div class="row" v-if="!generated">
                                    <div class="col-12 text-center">
                                        <div class="form-label-group">
                                            <input v-if="!generated" v-model="widgetname" type="text" class="form-control col-md-6 offset-md-3" placeholder="Ingrese un nombre para su widget" />
                                        </div>
                                    </div>
                                    <div class="col-12 text-center">
                                        <div class="form-label-group">
                                            <input v-if="!generated" v-model="url" type="text" class="form-control col-md-6 offset-md-3" placeholder="Ingrese URL del sitio web" />
                                ...
                                <div class="row mt-2" v-if="generated">
                                    <div class="col-12 text-center">
                                        ...
                                        <fieldset class="form-group">
                                            <textarea class="form-control mx-1 my-1" v-model="script" id="scriptText" rows="7" :disabled="isDisabled" placeholder="Textarea"></textarea>
                                        </fieldset>
                                        <h4>Como segundo paso debes insertar las siguientes etiquetas en la sección de tu web donde quieras que se muestre</h4>
                                        <fieldset class="form-group">
                                            <textarea class="form-control mx-1 my-1" id="labelHtml" rows="1" :disabled="isDisabled" placeholder="Textarea">
                      <div class="widget-vendedores" id="widget-vendedores"></div>
                      </textarea>
                                        </fieldset>
                                        <input type="button" @click="copyScript" value="Copiar script" class="btn btn-outline-primary mr-1 mb-1 waves-effect waves-light float-right" />
                                    </div>
