          ...
          <div class="content-body">
            <div id="searchSection" class="row my-1">
              ...
              <div class="col-12 mb-1">
                <div
                  class="search-results text-white"
                >Tiene {{ totalNegotiations }} negociaciones en total</div>
              </div>
  ...
  methods: {
    ...
    updateModuleSizes() {
      let ventonicMenuWidth = document.body.querySelector("div.main-menu")
        .offsetWidth; // Ventonic ppal menu options.
      let headerNavbarShadowHeight = document.body.querySelector(
        "#headerNavbarShadow"
      ).offsetHeight; // Header navbar shadow.
      let navControlsHeight = document.body.querySelector("#navControls")
        .offsetHeight; // Nav Controls.
      let appFooterHeight = document.body.querySelector("#appFooter")
        .offsetHeight; // App Footer.
      ...
      document.body.querySelector("#filtersCard").style.height =
        lgFiltersBarHeight -
        (document.querySelector("#lgFiltersBar").children[0].offsetHeight +
          32) +
        "px";

      // Set search & bar width.
      document.body.querySelector("#searchAndListsCol").style.width =
        this.window.width - (ventonicMenuWidth + lgFiltersBarWidth + 56) + "px";
