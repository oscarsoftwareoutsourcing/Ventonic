$(window).on("load", function() {
	...
	new ApexCharts(document.querySelector("#orders-received-chart"), n).render();
	var i = {
		chart: {
			type: "bar",
			height: 200,
	...
	new ApexCharts(document.querySelector("#avg-session-chart"), i).render();
	var l = {
		chart: {
			height: 270,
			type: "radialBar"
	...
	}), 1200 < $(window).width() && !$("body").hasClass("menu-collapsed") ? p.start() : p.cancel(), $("body").hasClass("horizontal-menu") && p.cancel(), $(window).on("resize", function() {
		p.cancel()
	})*/
});